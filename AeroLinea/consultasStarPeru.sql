...
INSERT INTO Usuarios (nombresUsuario, apellidosUsuario, nacimientoUsuario, telefonoUsuario, identificacionUsuario, correoUsuario, contrasenaUsuario, esAdmin, discapacidad, condicionUsuario)
VALUES ('Admin', 'Sistema', '1990-01-01', '999999999', '12345678', 'admin@gmail.com', 'Admin123*', 1, 0, '');

INSERT INTO Usuarios (nombresUsuario, apellidosUsuario, nacimientoUsuario, telefonoUsuario, identificacionUsuario, correoUsuario, contrasenaUsuario, esAdmin, discapacidad, condicionUsuario)
VALUES ('Renzo Nicolas', 'Salazar Valenzuela', '2004-02-27', '999999999', '12345671', 'renzo@gmail.com', 'Renzo123*', 0, 0, '');
...
VALUES 
('Lima', 'Chiclayo', '2024-03-20 08:00:00', 250.00, 1, 1),
('Lima', 'Cajamarca', '2024-03-20 09:30:00', 280.00, 2, 2),
('Lima', 'Huanuco', '2024-03-20 10:00:00', 220.00, 1, 3),
('Lima', 'Iquitos', '2024-03-20 11:30:00', 350.00, 2, 1),
('Lima', 'Tarapoto', '2024-03-20 13:00:00', 300.00, 1, 2),
('Lima', 'Pucallpa', '2024-03-20 14:30:00', 320.00, 2, 3),
('Lima', 'Lima', '2024-03-20 16:00:00', 200.00, 1, 1);
